...
An area contributes points once, no matter how many files matched it. Most scaled areas use three bands, so a trivial touch and a substantial rewrite are not equivalent:
