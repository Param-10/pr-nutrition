...
For historical pull requests and the planned local 25–50 PR corpus, see the [real-world benchmark guide](https://github.com/Param-10/pr-nutrition/blob/main/docs/real-world-benchmark.md).
